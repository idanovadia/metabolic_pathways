...
Sub2Vec_doc2vec_args = [
    {"vector_size": 10, "window_size": 5, "learning_rate": 0.001, "min_learning_rate": 0.0001, "min_count": 1,
     "min_vocab_size": "None", "workers": 4, "epochs": 50},
    {"vector_size": 10, "window_size": 5, "learning_rate": 0.001, "min_learning_rate": 0.001, "min_count": 1,
     "min_vocab_size": "None", "workers": 4, "epochs": 50},
    {"vector_size": 10, "window_size": 5, "learning_rate": 0.001, "min_learning_rate": 0.0001, "min_count": 1,
     "min_vocab_size": "None", "workers": 4, "epochs": 100}
]
...
Classifier_classifiers_args = [
    {"random_forest_max_depth": 3, "random_forest_n_estimators": 200,
