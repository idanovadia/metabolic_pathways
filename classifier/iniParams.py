...
GraphCreator_threshold = [str(x) for x in numpy.arange(0.7, 0.9, 0.1)]
# GraphCreator_threshold = [str(x) for x in numpy.arange(-1, 1, 0.1)]
...
Sub2Vec_random_walk_number = ["7"]
Sub2Vec_doc2vec_args = [
    {"vector_size": 10, "window_size": 2, "learning_rate": 0.025, "min_learning_rate": 0.001, "min_count": 1,
     "min_vocab_size": "None", "workers": 4, "epochs": 50}
]
# Sub2Vec_rw_extensions = ["''","'rw_on_main_graph'"]
...
Classifier_classifiers_args = [
    {"random_forest_max_depth": 7, "random_forest_n_estimators": 500,
